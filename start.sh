...
then
  ...
  make bcd o='init validator --chain-id vbstreetz'
  ...
  echo "typical abstract shoe junior annual idle conduct extend high source cliff zero quality brick fluid spare roast pulp claw swear bicycle lens teach digital" | make bccli o='keys add vb --recover --keyring-backend test'
  echo "mix swift essence lawsuit plastic major social copper chicken aisle caution unfold leaf turtle prize remove gravity tourist gym parade number street twelve long" | make bccli o='keys add band --recover --keyring-backend test'
  ...
  make bcd o='add-genesis-account vb 10000000000000stake --keyring-backend test'
  make bcd o='add-genesis-account band 10000000000000stake --keyring-backend test'

  make bccli o='config chain-id vbstreetz'
